...
public class BoardComboDTO {
	...
	//private String boardComboImage; 
	...
	//private boolean isLiked; // 좋아요 눌렀는지 여부(글 상세 페이지)
	...
	public String toString() {
		return "BoardComboDTO [boardComboNumber=" + boardComboNumber + ", boardComboTitle=" + boardComboTitle
