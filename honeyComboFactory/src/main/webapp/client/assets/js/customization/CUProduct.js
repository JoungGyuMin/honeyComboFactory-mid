...
const loadMoreHotUrl = "/honeyComboFactory/CuHotIssueProductServlet"; // 핫이슈 불러오기 서블릿 url
const loadMorePlusUrl = "/honeyComboFactory/CuPlusOneProductServlet"; // +1증정 불러오기 서블릿 url
const loadMoreCUUrl = "/honeyComboFactory/OrderCuProductServlet"; // CU상품 불러오기 서블릿 url
const searchCUProductNameUrl = "/honeyComboFactory/SearchCuProductServlet"; // CU상품 이름 검색 서블릿 url
