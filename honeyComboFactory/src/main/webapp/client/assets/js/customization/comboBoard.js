 ...
 *  꿀조합 게시판 js
 */
const loadMoreComboBoardUrl = "/honeyComboFactory/BoardComboOrderServlet"; // 글 정보 불러오기 서블릿 url
const searchComboBoardTitleUrl = "/honeyComboFactory/SearchComboBoardServlet"; // 글 제목 검색 서블릿 url
