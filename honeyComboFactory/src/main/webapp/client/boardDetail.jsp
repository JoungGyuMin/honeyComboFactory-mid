			...
			<div class="container">
				...
				<table id="boardDetailTable">
					...
					<tr>
						...
						<th>제목</th>
						<td colspan="3">${boardComboDetailData.boardComboTitle}</td>
					</tr>
					<tr>
						<td colspan="6">
							<div id="boardDetailContent">
								${boardComboDetailData.boardComboContent}</div>
						</td>
					</tr>
				</table>
				<!-- 게시글 End -->
							...
							<div class="select-itms">
								<c:if
									...
									<a href="javascript:void(0);" class="genric-btn warning radius"
										onclick="updateComboBoard(${boardComboDetailData.boardComboNumber})">수정</a>
								</c:if>
								<c:if
